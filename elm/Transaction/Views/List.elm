...
import Transaction.TransactionMsgB exposing ( TransactionMsgB ( DeleteTransaction ) )
...
view model =
    template ( div []
        ...
        , viewTransactionsOrError model.transactions
        ] )


viewTransactionsOrError : Transaction.Model.Model -> Html Msg
    ...
    in
        tr []
            ...
            , td [ id "deleteTransaction" ]
                [ button [ class "button is-link is-danger", onClick ( TransactionMsgA ( DeleteTransaction transaction.id) ) ]
                    [ text "Delete" ]
                ]
            ]
