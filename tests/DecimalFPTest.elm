...
dfp_addTests =
    test "dfp_add"
        (\_ -> Expect.equal (DecimalFP.dfp_add (DFP 1 0) (DFP -1 0)) (DFP 0 0) )
...
roundTests =
    describe "round"
        [ test "-5 555 -4" (\_ -> Expect.equal (DecimalFP.round -5 (DFP 555 -4) ) (DFP 555 -4) )
        , test "-4 555 -4" (\_ -> Expect.equal (DecimalFP.round -4 (DFP 555 -4) ) (DFP 555 -4) )
        , test "-3 555 -4" (\_ -> Expect.equal (DecimalFP.round -3 (DFP 555 -4) ) (DFP 56 -3) )
        , test "-2 555 -4" (\_ -> Expect.equal (DecimalFP.round -2 (DFP 555 -4) ) (DFP 6 -2) )
        , test "-1 555 -4" (\_ -> Expect.equal (DecimalFP.round -1 (DFP 555 -4) ) (DFP 1 -1) )
        , test "0 555 -4" (\_ -> Expect.equal (DecimalFP.round 0 (DFP 555 -4) ) (DFP 0 0) )

        , test "-4 555 -3" (\_ -> Expect.equal (DecimalFP.round -4 (DFP 555 -3) ) (DFP 555 -3) )
        , test "-3 555 -3" (\_ -> Expect.equal (DecimalFP.round -3 (DFP 555 -3) ) (DFP 555 -3) )
        , test "-2 555 -3" (\_ -> Expect.equal (DecimalFP.round -2 (DFP 555 -3) ) (DFP 56 -2) )
        , test "-1 555 -3" (\_ -> Expect.equal (DecimalFP.round -1 (DFP 555 -3) ) (DFP 6 -1) )
        , test "0 555 -3" (\_ -> Expect.equal (DecimalFP.round 0 (DFP 555 -3) ) (DFP 1 0) )
        , test "1 555 -3" (\_ -> Expect.equal (DecimalFP.round 1 (DFP 555 -3) ) (DFP 0 1) )

        , test "-3 555 -2" (\_ -> Expect.equal (DecimalFP.round -3 (DFP 555 -2) ) (DFP 555 -2) )
        , test "-2 555 -2" (\_ -> Expect.equal (DecimalFP.round -2 (DFP 555 -2) ) (DFP 555 -2) )
        , test "-1 555 -2" (\_ -> Expect.equal (DecimalFP.round -1 (DFP 555 -2) ) (DFP 56 -1) )
        , test "0 555 -2" (\_ -> Expect.equal (DecimalFP.round 0 (DFP 555 -2) ) (DFP 6 0) )
        , test "1 555 -2" (\_ -> Expect.equal (DecimalFP.round 1 (DFP 555 -2) ) (DFP 1 1) )
        , test "2 555 -2" (\_ -> Expect.equal (DecimalFP.round 2 (DFP 555 -2) ) (DFP 0 2) )

        , test "-2 555 -1" (\_ -> Expect.equal (DecimalFP.round -2 (DFP 555 -1) ) (DFP 555 -1) )
        , test "-1 555 -1" (\_ -> Expect.equal (DecimalFP.round -1 (DFP 555 -1) ) (DFP 555 -1) )
        , test "0 555 -1" (\_ -> Expect.equal (DecimalFP.round 0 (DFP 555 -1) ) (DFP 56 0) )
        , test "1 555 -1" (\_ -> Expect.equal (DecimalFP.round 1 (DFP 555 -1) ) (DFP 6 1) )
        , test "2 555 -1" (\_ -> Expect.equal (DecimalFP.round 2 (DFP 555 -1) ) (DFP 1 2) )
        , test "3 555 -1" (\_ -> Expect.equal (DecimalFP.round 3 (DFP 555 -1) ) (DFP 0 3) )

        , test "-1 555 0" (\_ -> Expect.equal (DecimalFP.round -1 (DFP 555 0) ) (DFP 555 0) )
        , test "0 555 0" (\_ -> Expect.equal (DecimalFP.round 0 (DFP 555 0) ) (DFP 555 0) )
        , test "1 555 0" (\_ -> Expect.equal (DecimalFP.round 1 (DFP 555 0) ) (DFP 56 1) )
        , test "2 555 0" (\_ -> Expect.equal (DecimalFP.round 2 (DFP 555 0) ) (DFP 6 2) )
        , test "3 555 0" (\_ -> Expect.equal (DecimalFP.round 3 (DFP 555 0) ) (DFP 1 3) )
        , test "4 555 0" (\_ -> Expect.equal (DecimalFP.round 4 (DFP 555 0) ) (DFP 0 4) )

        , test "0 555 1" (\_ -> Expect.equal (DecimalFP.round 0 (DFP 555 1) ) (DFP 555 1) )
        , test "1 555 1" (\_ -> Expect.equal (DecimalFP.round 1 (DFP 555 1) ) (DFP 555 1) )
        , test "2 555 1" (\_ -> Expect.equal (DecimalFP.round 2 (DFP 555 1) ) (DFP 56 2) )
        , test "3 555 1" (\_ -> Expect.equal (DecimalFP.round 3 (DFP 555 1) ) (DFP 6 3) )
        , test "4 555 1" (\_ -> Expect.equal (DecimalFP.round 4 (DFP 555 1) ) (DFP 1 4) )
        , test "5 555 1" (\_ -> Expect.equal (DecimalFP.round 5 (DFP 555 1) ) (DFP 0 5) )
        ]
